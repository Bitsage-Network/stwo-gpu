use elo_cairo_verifier::channel::{
    PoseidonChannel, channel_default, channel_draw_qm31, channel_mix_secure_field, channel_mix_u64,
};
...
use elo_cairo_verifier::field::{CM31, QM31, fold_mle_eval, qm31_eq, qm31_new};
...
fn construct_output_claim(ref ch: PoseidonChannel, output_v0: u64, output_v1: u64) -> GKRClaim {
    ...
    GKRClaim { point: array![r0], value: output_value }
}
...
fn build_sp3_matmul_only_proof_data() -> Array<felt252> {
    array![
        ...
        0x0, // num_rounds = 2
        0x2, // round[0].c0 (QM31)
        0x4c3999da, 0x34cddf9a, 0x447004b2,
        0x4b11507f, // round[0].c2 (QM31) — c1 omitted
        0x10, 0x0, 0x0, 0x0, // round[1].c0 (QM31)
        0x59c30da5, 0x57a1304f, 0x61fa59de, 0x5d27936d, // round[1].c2 (QM31) — c1 omitted
        0x2,
        0x0, 0x0, 0x0, // final_a_eval (QM31)
        0x300af73c, 0x7b4d242b, 0x4992e6b7,
        0x2b489ae1, // final_b_eval (QM31)
        0x242921be, 0x5d8992e0, 0x54a079aa,
        0x1a41a5ed, // num_deferred = 0 (no DAG Add layers)
        0x0,
    ]
}
...
fn test_sp3_matmul_only_final_claim_value() {
    ...
    let (final_claim, _) = verify_gkr_model(
        proof_data.span(), 1, matmul_dims.span(), array![].span(), initial_claim, ref ch,
    );
...
fn test_sp3_matmul_only_tampered_rejects() {
    ...
    let proof_data: Array<felt252> = array![
        ...
        0x4c3999db, 0x34cddf9a, 0x447004b2,
        0x4b11507f, // round[0].c2
        0x10, 0x0, 0x0, 0x0, // round[1].c0
        0x59c30da5, 0x57a1304f,
        0x61fa59de, 0x5d27936d, // round[1].c2
        0x2, 0x0, 0x0, 0x0, // final_a_eval
        0x300af73c,
        0x7b4d242b, 0x4992e6b7, 0x2b489ae1, // final_b_eval
        0x242921be, 0x5d8992e0, 0x54a079aa,
        0x1a41a5ed,
    ];
...
fn test_sp3_matmul_only_tampered_final_rejects() {
    ...
    let proof_data: Array<felt252> = array![
        0x0, 0x2, // round[0].c0
        0x4c3999da, 0x34cddf9a, 0x447004b2, 0x4b11507f, // round[0].c2
        0x10, 0x0, 0x0, 0x0, // round[1].c0
        0x59c30da5, 0x57a1304f, 0x61fa59de,
        0x5d27936d, // round[1].c2
        0x2, 0x0, 0x0,
        0x0, // final_a_eval — TAMPERED: 0x300af73c → 0x300af73d (+1)
        0x300af73d, 0x7b4d242b,
        0x4992e6b7, 0x2b489ae1, // final_b_eval
...
fn build_sp3_weight_opening_proof_data() -> Array<felt252> {
    array![
        ...
        0x2, 0x32af8fd28517d67b4a36b4a05b422da2d55a15a9c1d6ffd2c99bed93b1e3659,
        0x6fe0b662f3b2a5ca034bbebe1d6750d4bc1a4feeef133ee5db36116585e04a9, // queries: Array<MleQueryProof> (len=4)
        0x10000000400000000000000000000000,
        0x495ab9242f2ec905679ed8d6af6414b4dc897336d31719b68e573911043c180,
        0x12a72ae943d9780522015b25a33677c130cf2e3ca7cab6111f387c0572cea41, // Q2 R1
        0x44133349,
        0x66ef4a88, 0x417aac3b, 0x43b0702a, 0x4413334d, 0x66ef4a88, 0x417aac3b, 0x43b0702a, 0x2,
        0x18826668f9bbd2a220bd561dc3b0702a,
        0x4458b2d010efa202ef05ef9980c80ca06d4d8bd4718b512a20cecc76818631, 0x2,
        0x1882666979bbd2a220bd561dc3b0702a,
        0xf7e1013873b4fe7e32273e9ea1aa97c075a6111259f180555224f386c5510f, // Q2 R2
        0x211818db,
        0x307adaac, 0x6cff5b1, 0x5d2df91, 0x211818dd, 0x307adaac, 0x6cff5b1, 0x5d2df91, 0x1,
        0x1423031bac1eb6ab0367fad885d2df91, 0x1,
        0x1423031b6c1eb6ab0367fad885d2df91, // ---- Query 3: initial_pair_index=2, rounds=3 ----
        0x2, 0x3, 0x5, 0x0, 0x0, 0x0, 0x6, 0x0, 0x0, 0x0, 0x3, 0x10000000e00000000000000000000000,
        0x1b537b28eb8c5c619cecea97d60b41e915ab177027b4ef363162ca5742e2184,
        0x523409a865968ce30bd0ff99140c9dc235ec925370279c43d59beb5bfe4c1ac, 0x3,
        0x10000001000000000000000000000000,
        0x7629454ecc4eaca72b489df1ec392edf4bb1df3dca0b8c3bbf5ab1d1a1cbd9f,
        0x12a72ae943d9780522015b25a33677c130cf2e3ca7cab6111f387c0572cea41, // Q3 R1
        0x44133347,
        0x66ef4a88, 0x417aac3b, 0x43b0702a, 0x4413334b, 0x66ef4a88, 0x417aac3b, 0x43b0702a, 0x2,
        0x1882666939bbd2a220bd561dc3b0702a,
        0x4458b2d010efa202ef05ef9980c80ca06d4d8bd4718b512a20cecc76818631, 0x2,
        0x18826669b9bbd2a220bd561dc3b0702a,
        0xf7e1013873b4fe7e32273e9ea1aa97c075a6111259f180555224f386c5510f, // Q3 R2
        0x211818db,
        0x307adaac, 0x6cff5b1, 0x5d2df91, 0x211818dd, 0x307adaac, 0x6cff5b1, 0x5d2df91, 0x1,
        0x1423031bac1eb6ab0367fad885d2df91, 0x1,
        0x1423031b6c1eb6ab0367fad885d2df91, // final_value: QM31(0x242921be, 0x5d8992e0, 0x54a079aa, 0x1a41a5ed)
        0x242921be, 0x5d8992e0, 0x54a079aa, 0x1a41a5ed,
    ]
}
...
fn test_sp3_weight_opening_verification_passes() {
    ...
    let valid = verify_mle_opening(weight_commitment, @proof, claim.eval_point.span(), ref ch);
...
fn test_sp3_tampered_weight_opening_rejected() {
    ...
    let valid = verify_mle_opening(bad_commitment, @proof, claim.eval_point.span(), ref ch);
